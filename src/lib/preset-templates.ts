...
export const PRESET_TEMPLATES: PresetTemplate[] = [
  {
    ...
    columns: [
      ...
      { key: '\u68C0\u9A8C\u5927\u7C7B/\u75C5\u7406/\u8BCA\u65AD', type: 'string', description: '\u68C0\u9A8C\u5927\u7C7B\u3001\u75C5\u7406\u7C7B\u578B\u6216\u8BCA\u65AD\u540D\u79F0', example: '\u751F\u5316\u68C0\u9A8C' },
      { key: '\u68C0\u9A8C\u9879\u76EE/\u75C5\u7406\u79CD\u7C7B/\u8BCA\u65AD\u7C7B\u578B', type: 'string', description: '\u68C0\u9A8C\u9879\u76EE\u3001\u75C5\u7406\u79CD\u7C7B\u6216\u8BCA\u65AD\u7C7B\u578B', example: '\u767D\u7EC6\u80CC', repeating: true },
      ...
      { key: '\u75C5\u7406\u6837\u672C\u7F16\u53F7', type: 'string', description: '\u75C5\u7406\u6837\u672C\u7F16\u53F7', example: 'S2024-001' },
      { key: '\u75C5\u7406\u62A5\u544A\u7F16\u53F7', type: 'string', description: '\u75C5\u7406\u62A5\u544A\u7F16\u53F7', example: 'P2024-001' },
    ],
  },
  {
    id: 'blood-routine',
