...
// ---------------------------------------------------------------------------
// Fill missing headers and build final UnifiedSchema from merged records
// ---------------------------------------------------------------------------

import type { MergedRecord, UnifiedSchema, DisplayRow } from './types';

export function buildUnifiedSchemaFromMerged(
  ...
  for (const record of mergedRecords) {
    const alignedData = { ...record.data };

    // Fill missing headers with null
    for (const h of headers) {
      if (alignedData[h] === undefined) {
        alignedData[h] = null;
      }
    }
